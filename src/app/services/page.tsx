    ...
    <main className="pt-12 md:pt-16 pb-24 px-6 max-w-[100rem] mx-auto">
      ...
      <header className="mb-24 flex flex-col md:flex-row md:items-end justify-between gap-12">
        <div className="max-w-4xl">
          ...
          <h1 className="text-5xl md:text-7xl font-headline font-bold tracking-tight text-white leading-tight mb-8">
            Premium digital solutions for ambitious businesses.{" "}
            <span className="text-primary italic">Built to Scale</span>
          </h1>
          <p className="text-body-lg text-slate-400 leading-relaxed text-lg">
      ...
      <section className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-32">
        ...
        <div className="md:col-span-4 vitality-gradient p-8 rounded-xl shadow-2xl shadow-primary/20">
          ...
          <div className="mt-8 flex gap-2">
            <span className="px-3 py-1 rounded-full bg-white/10 text-white text-[10px] font-label uppercase">
              AI Workflows
            </span>
            <span className="px-3 py-1 rounded-full bg-white/10 text-white text-[10px] font-label uppercase">
              LLM Integration
        ...
        {/* Portfolio Websites */}
        <div className="md:col-span-12 group relative overflow-hidden bg-surface-container-low h-64 rounded-xl flex items-center p-12 border border-white/5">
      ...
      <section className="py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-surface-container p-8 rounded-xl relative">
            <div className="text-7xl font-headline font-extrabold text-white/5 absolute -top-4 -left-2 select-none">
              01
            </div>
            <div className="relative z-10">
      ...
      <section className="mt-24 rounded-2xl overflow-hidden relative">
        ...
        <div className="bg-surface-container-high p-12 md:p-20 text-center relative z-10 border border-white/5">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/contact"
              className="vitality-gradient px-10 py-4 rounded-full text-white font-bold text-lg hover:scale-105 transition-transform inline-flex items-center justify-center"
            >
              Schedule a Call
            </Link>
            <Link href="/portfolio"
              className="bg-white/5 hover:bg-white/10 border border-white/10 px-10 py-4 rounded-full text-white font-bold text-lg transition-colors flex items-center justify-center"
            >
              View Portfolio
            </Link>
          </div>
