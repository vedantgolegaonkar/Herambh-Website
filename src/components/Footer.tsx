...
export default function Footer() {
  return (
    <footer className="bg-slate-950 w-full pt-24 pb-12 border-t border-white/5">
      <div className="max-w-[100rem] mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
        ...
        <div>
          <h5 className="text-white font-headline font-semibold mb-8">Legal</h5>
          <ul className="space-y-4">
            <li>
              <a href="#" className="text-slate-500 hover:text-green-500 transition-colors font-body">
                Privacy Policy
              </a>
            </li>
            <li>
      ...
      <div className="max-w-[90rem] mx-auto px-6 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
        <p className="text-slate-500 text-sm font-body">
          © 2024 Herambh Software Technologies & Solutions. All rights reserved.
        </p>
        <div className="flex gap-8">
          <a href="#" className="text-slate-500 hover:text-green-500 text-sm font-body transition-colors">
            Privacy Policy
          </a>
          <a href="#" className="text-slate-500 hover:text-green-500 text-sm font-body transition-colors">
            Terms of Service
